# -*- coding: utf-8 -*-
"""Copy of 00-simple-local-rag.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1gLNWEwmA2dxrOZUKz8RT3g331pZthgPv
...
if "COLAB_GPU" in os.environ:
    ...
    #!pip install -U torchvision==0.17.2
    #!pip install -U torchaudio==2.2.2
    #!pip install -U torch # requires torch 2.1.1+ (for efficient sdpa implementation)
    !pip install PyMuPDF # for reading PDFs with Python
    !pip install tqdm # for progress bars
    !pip install sentence_transformers==2.5.1 # for embedding models
